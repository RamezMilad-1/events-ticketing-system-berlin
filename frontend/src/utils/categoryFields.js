...
export const categoryFields = {
    ...
    theater: {
        ...
        seating_rows: { type: 'number', label: 'Number of Rows', placeholder: '10', required: false, min: 1, max: 50 },
        seating_columns: { type: 'number', label: 'Seats per Row', placeholder: '20', required: false, min: 1, max: 50 },
        ticket_types: {
            type: 'array',
            label: 'Ticket Types',
            placeholder: 'Add ticket types',
